...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("Command not valid, Create requires a name,type of gradebook, if its's weighted (true/false).");
                return;
            }
            var name = parts[1];
            ...
            {
                Console.WriteLine("{0} us not supported type of gradebook, please try again.", type);
                return;
            }
